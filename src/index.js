...
import HeaderResponsive from "./components/navResponsive";
...
const Root = () => {
  ...
  return (
    <React.StrictMode>
      ...
      <HeaderResponsive home={home} aboutme={aboutme} projectsworks={projectsworks} skills={skills} contact={contact}>
      </HeaderResponsive>
      <button className="changelang" onClick={() => setLang(lang === "en" ? "es" : "en")}>
        <img src={button} alt="Change lang img"/>
      </button>
